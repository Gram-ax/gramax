...
#[em_bindgen]
pub fn pull_lfs_objects(repo_path: String, creds: AccessTokenCreds, paths: Vec<PathBuf>, checkout: bool, cancel_token: usize) -> Result<()> {
	git::pull_lfs_objects(Path::new(&repo_path), creds, paths, checkout, cancel_token.into())
}
