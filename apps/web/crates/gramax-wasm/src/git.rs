...
#[em_bindgen(json)]
pub fn format_merge_message(repo_path: String, creds: AccessTokenCreds, opts: MergeMessageFormatOptions) -> Result<String> {
...
#[em_bindgen]
pub fn delete_branch(repo_path: String, name: String, remote: bool, creds: Option<AccessTokenCreds>) -> Result<()> {
...
#[em_bindgen]
pub fn fetch(repo_path: String, creds: AccessTokenCreds, opts: RemoteOptions<'static>, lock: bool) -> Result<()> {
...
#[em_bindgen(json)]
pub fn has_merge_conflicts(repo_path: String, creds: AccessTokenCreds, branch: String) -> Result<Vec<PathBuf>> {
	git::has_merge_conflicts(Path::new(&repo_path), creds, &branch)
}
...
#[em_bindgen]
pub fn create_or_update_merge_request(repo_path: String, creds: AccessTokenCreds, merge_request: CreateMergeRequest) -> Result<()> {
...
pub fn pull_lfs_objects(
	...
	git::pull_lfs_objects(Path::new(&repo_path), creds, scope, paths, checkout, cancel_token.into())
}
...
#[em_bindgen]
pub fn set_config_val(repo_path: String, name: String, val: gramaxgit::ConfigValue) -> Result<()> {
	git::set_config_val(Path::new(&repo_path), &name, val)
}
