...
const inputClassName =
	"h-10 w-full rounded-lg border border-secondary-border bg-secondary-bg px-3 py-2.5 shadow-soft-sm outline-none transition-all lg:h-9 lg:py-2 font-sans text-sm text-primary-fg placeholder:text-muted hover:border-primary-border hover:shadow-soft-base focus:rounded-lg focus:border focus:border-secondary-border focus:bg-secondary-bg focus:shadow-focus read-only:border-primary-border read-only:shadow-soft-sm  read-only:focus:bg-secondary-bg-hover disabled:border-primary-border disabled:bg-secondary-bg-hover disabled:shadow-soft-sm invalid:border-status-error-secondary-border invalid:shadow-soft-base invalid:hover:border-status-error-primary-border invalid:hover:shadow-soft-base invalid:focus:border-status-error-secondary-border invalid:focus:shadow-focus-error aria-[invalid=true]:border-status-error-secondary-border aria-[invalid=true]:shadow-soft-base aria-[invalid=true]:hover:border-status-error-primary-border aria-[invalid=true]:hover:shadow-soft-base aria-[invalid=true]:focus:border-status-error-secondary-border aria-[invalid=true]:focus:shadow-focus-error";
