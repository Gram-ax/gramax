...
// 		const result = await styleGuideChecker.check({ paragraphs });
...
// 					<ButtonLink iconCode="spell-check" text={t("style-guide.check-with-style-guide")} />
// 				</DropdownMenuTrigger>
// 				<DropdownMenuContent align="start">
// 					<DropdownMenuItem>
// 						<Icon code="file-check-2" />
// 						{t("style-guide.check-article")}
// 					</DropdownMenuItem>
// 				</DropdownMenuContent>
// 			</DropdownMenu>
// 			{/* <PopupMenuLayout
