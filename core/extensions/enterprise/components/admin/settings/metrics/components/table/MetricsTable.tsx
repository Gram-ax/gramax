...
import { createMetricsTableColumns, MetricsTableRow } from "./MetricsTableConfig";
...
const MetricsTable = ({
	...
	const initialData = metricsSettings.tableData ?? [];
	...
	const { getSelectedItems } = useTableSelection({
		table: table as any,
		isRowDisabled: () => false,
	});
	...
	}, [rowSelection, getSelectedItems, selectedArticleIds, loadFilteredChartData, onFilteredChartDataChange]);
