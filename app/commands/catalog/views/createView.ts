...
const createView: Command<{ ctx: Context; catalogName: string; view: CatalogView }, void> = Command.create({
	path: "catalog/views/create",
	...
	async do({ catalogName, view }) {
		...
		await catalog.customProviders.viewProvider.createView(view);
	},
